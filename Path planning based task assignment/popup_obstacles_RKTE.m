...
vrt(6,1:2) = [40 -100]*scale;
vrt(7,1:2) = [70 -110]*scale;
vrt(8,1:2) = [70 -130]*scale;
vrt(9,1:2) = [40 -140]*scale;
vrt(10,1:2) = [40 -100]*scale;
vrt(6:10,3) = 2 ; 

vrt(11,1:2) = [75 25]*scale;
vrt(12,1:2) = [100 25]*scale;
vrt(13,1:2) = [110 -25]*scale;
vrt(14,1:2) = [70 -20 ]*scale;
vrt(15,1:2) = [75 25]*scale;
vrt(11:15,3) = 3 ; 

vrt(16,1:2) = [5 -5]*scale;
vrt(17,1:2) = [20 5]*scale;
vrt(18,1:2) = [25 -20]*scale;
vrt(19,1:2) = [-5 -40]*scale;
vrt(20,1:2) = [5 -5]*scale;
vrt(16:20,3) = 4 ; 
